...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;                   ~~ Dark ~~                                   ~~ Light ~~
        ;;                                                               GUI       TER                                GUI       TER
        ;; generic
        (act1          (if (eq variant 'dark) (if (display-graphic-p) "#002B36" "#121212") (if (display-graphic-p) "#e7e5eb" "#d7dfff")))
        (act2          (if (eq variant 'dark) (if (display-graphic-p) "#586E75" "#444444") (if (display-graphic-p) "#d3d3e7" "#afafd7")))
        (base          (if (eq variant 'dark) (if (display-graphic-p) "#839496" "#b2b2b2") (if (display-graphic-p) "#655370" "#5f5f87")))
        (base-dim      (if (eq variant 'dark) (if (display-graphic-p) "#545557" "#585858") (if (display-graphic-p) "#cdc5c8" "#afafd7")))
        (bg1           (if (eq variant 'dark) (if (display-graphic-p) "#002B36" "#262626") (if (display-graphic-p) "#fbf8ef" "#ffffff")))
        (bg2           (if (eq variant 'dark) (if (display-graphic-p) "#073642" "#1c1c1c") (if (display-graphic-p) "#efeae9" "#e4e4e4")))
        (bg3           (if (eq variant 'dark) (if (display-graphic-p) "#073642" "#121212") (if (display-graphic-p) "#e3dedd" "#d0d0d0")))
        (bg4           (if (eq variant 'dark) (if (display-graphic-p) "#073642" "#080808") (if (display-graphic-p) "#d2ceda" "#bcbcbc")))
        (border        (if (eq variant 'dark) (if (display-graphic-p) "#586E75" "#111111") (if (display-graphic-p) "#b3b9be" "#b3b9be")))
        ...
        (cursor        (if (eq variant 'dark) (if (display-graphic-p) "#586E75" "#d0d0d0") (if (display-graphic-p) "#100a14" "#121212")))
        (const         (if (eq variant 'dark) (if (display-graphic-p) "#A082BD" "#d75fd7") (if (display-graphic-p) "#4e3163" "#8700af")))
        (comment       (if (eq variant 'dark) (if (display-graphic-p) "#586E75" "#008787") (if (display-graphic-p) "#2aa1ae" "#008787")))
        (comment-bg    (if (eq variant 'dark) (if (display-graphic-p) "#002B36" "#262626") (if (display-graphic-p) "#ecf3ec" "#ffffff")))
        (comp          (if (eq variant 'dark) (if (display-graphic-p) "#CB4B16" "#d75fd7") (if (display-graphic-p) "#6c4173" "#8700af")))
        (err           (if (eq variant 'dark) (if (display-graphic-p) "#e0211d" "#e0211d") (if (display-graphic-p) "#e0211d" "#e0211d")))
        (func          (if (eq variant 'dark) (if (display-graphic-p) "#B58900" "#d75fd7") (if (display-graphic-p) "#6c3163" "#8700af")))
        (head1         (if (eq variant 'dark) (if (display-graphic-p) "#268BD2" "#268bd2") (if (display-graphic-p) "#3a81c3" "#268bd2")))
        (head1-bg      (if (eq variant 'dark) (if (display-graphic-p) "#293239" "#262626") (if (display-graphic-p) "#edf1ed" "#ffffff")))
        (head2         (if (eq variant 'dark) (if (display-graphic-p) "#2AA198" "#2aa198") (if (display-graphic-p) "#2d9574" "#2aa198")))
        (head2-bg      (if (eq variant 'dark) (if (display-graphic-p) "#293235" "#262626") (if (display-graphic-p) "#edf2e9" "#ffffff")))
        (head3         (if (eq variant 'dark) (if (display-graphic-p) "#B58900" "#67b11d") (if (display-graphic-p) "#67b11d" "#5faf00")))
        (head3-bg      (if (eq variant 'dark) (if (display-graphic-p) "#293235" "#262626") (if (display-graphic-p) "#edf2e9" "#ffffff")))
        (head4         (if (eq variant 'dark) (if (display-graphic-p) "#A082BD" "#875f00") (if (display-graphic-p) "#b1951d" "#875f00")))
        (head4-bg      (if (eq variant 'dark) (if (display-graphic-p) "#32322c" "#262626") (if (display-graphic-p) "#f6f1e1" "#ffffff")))
        (highlight     (if (eq variant 'dark) (if (display-graphic-p) "#E0E2E4" "#444444") (if (display-graphic-p) "#d3d3e7" "#d7d7ff")))
        (keyword       (if (eq variant 'dark) (if (display-graphic-p) "#268BD2" "#268bd2") (if (display-graphic-p) "#3a81c3" "#268bd2")))
        (lnum          (if (eq variant 'dark) (if (display-graphic-p) "#44505c" "#444444") (if (display-graphic-p) "#a8a8bf" "#af87af")))
        (mat           (if (eq variant 'dark) (if (display-graphic-p) "#CB4B16" "#86dc2f") (if (display-graphic-p) "#ba2f59" "#af005f")))
        (meta          (if (eq variant 'dark) (if (display-graphic-p) "9f8766" "#af875f") (if (display-graphic-p) "#da8b55" "#df5f5f")))
        (str           (if (eq variant 'dark) (if (display-graphic-p) "#2AA198" "#2aa198") (if (display-graphic-p) "#2d9574" "#2aa198")))
        ...
        (type          (if (eq variant 'dark) (if (display-graphic-p) "#CB4B16" "#df005f") (if (display-graphic-p) "#ba2f59" "#af005f")))
        (var           (if (eq variant 'dark) (if (display-graphic-p) "#678CB1" "#8787d7") (if (display-graphic-p) "#715ab1" "#af5fd7")))
        ...
        (cyan          (if (eq variant 'dark) (if (display-graphic-p) "#268BD2" "#00ffff") (if (display-graphic-p) "#21b8c7" "#008080")))
