...
*** File setup
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defvar org-default-tech-notebook-dir (concat org-default-notebooks-dir "tech-notebook.org") "Information on technical topcics.")
     (defvar org-default-tech-notebook-dir (concat org-default-notebooks-dir "live-notebook.org") "Information on any topics.")
     (defvar org-default-tech-notebook-dir (concat org-default-notebooks-dir "hockey-notebook.org") "Information on hockey.")
...
**** Notes
    ...
    #+BEGIN_SRC emacs-lisp
      (add-to-list 'org-capture-templates
                   `("i" "Piece of information" entry (file, org-default-inbox-file)
                     "* NOTE %?
      :PROPERTIES:
      :CREATED:%U
      :END:
    ...
    #+BEGIN_SRC emacs-lisp
      (add-to-list 'org-capture-templates
                   `("I" "Piece of information from clipboard" entry (file, org-default-inbox-file)
                     "* NOTE %?
      :PROPERTIES:
      :CREATED:%U
      :END:
