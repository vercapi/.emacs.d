...
** TODO WorkFlow [0/1]
   ...
   Files we will need for the flow
   #+BEGIN_SRC emacs-lisp
     ...
     (defvar org-default-tech-notebook-dir (concat org-default-references-dir "tech-notebook.org") "Information on technical topcics.")
     (defvar org-default-tech-notebook-dir (concat org-default-references-dir "live-notebook.org") "Information on any topics.")
     (defvar org-default-tech-notebook-dir (concat org-default-references-dir "hockey-notebook.org") "Information on hockey.")
     (defvar org-default-official-documents-dir (concat org-default-references-dir "documents/") "Directory for official documents, non org files.")
   #+END_SRC

   - [ ] Oter files? Check current evernote structure
