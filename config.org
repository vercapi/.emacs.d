...
** Theme/Syntax sugar
   ...
   Highlight color
   #+BEGIN_SRC emacs-lisp
     (defconst pve-highlight-color "#2f4f4f")
   #+END_SRC
...
*** Visual awareness
    ...
    Highlight the current line and set a specific color.
    #+BEGIN_SRC emacs-lisp
      (global-hl-line-mode)
      (set-face-background 'hl-line pve-highlight-color)
    #+END_SRC
       ...
       (progn
         ...
         (treemacs-create-theme "pve"
           ...
           (progn
             ...
             (treemacs-create-icon :icon (all-the-icons-faicon "circle-o")       :extensions (root))
             (treemacs-create-icon :icon (all-the-icons-faicon "folder")         :extensions (dir-closed))
             (treemacs-create-icon :icon (all-the-icons-faicon "folder")         :extensions (dir-open))
             (treemacs-create-icon :icon (all-the-icons-faicon "circle")         :extensions (tag-leaf))
             (treemacs-create-icon :icon (all-the-icons-faicon "minus-square")   :extensions (tag-open))
             (treemacs-create-icon :icon (all-the-icons-faicon "plus-square")    :extensions (tag-closed))
             (treemacs-create-icon :icon (all-the-icons-material "error")        :extensions (error))
             (treemacs-create-icon :icon (all-the-icons-material "warning")      :extensions (warning))
             (treemacs-create-icon :icon (all-the-icons-material "info_outline") :extensions (info))

             ;; ;; file icons
             (treemacs-create-icon :icon (all-the-icons-fileicon "default")         :extensions (fallback))
             (treemacs-create-icon :icon (all-the-icons-fileicon "emacs")           :extensions ("el" "elc"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.yml")      :extensions ("yml" "yaml"))
             (treemacs-create-icon :icon (all-the-icons-fileicon "powershell")      :extensions ("sh" "zsh" "fish"))
             (treemacs-create-icon :icon (all-the-icons-octicon "file-pdf")         :extensions ("pdf"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.c")        :extensions ("c"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.h")        :extensions ("h"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.cc")       :extensions ("cpp" "cxx" "cc"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.hh")       :extensions ("hpp" "tpp" "hh"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.hs")       :extensions ("hs" "lhs" "cabal"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.py")       :extensions ("py" "pyc"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.md")       :extensions ("md"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.rs")       :extensions ("rs"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.jpg")      :extensions ("jpg" "jpeg" "bmp" "svg" "png" "xpm" "gif"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.clj")      :extensions ("clj" "cljs" "cljc"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.ts")       :extensions ("ts" "tsx"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.vue")      :extensions ("vue"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.css")      :extensions ("css"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.ini")      :extensions ("properties" "conf" "config" "cfg" "ini" "xdefaults" "xresources" "terminalrc" "ledgerrc"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.html")     :extensions ("html" "htm"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.git")      :extensions ("git" "gitignore" "gitconfig" "gitmodules"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.java")     :extensions ("java"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.kt")       :extensions ("kt"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.scala")    :extensions ("scala"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.sbt")      :extensions ("sbt"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.go")       :extensions ("go"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.js")       :extensions ("js" "jsx"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.json")     :extensions ("json"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.jl")       :extensions ("jl"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.ex")       :extensions ("ex"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.exs")      :extensions ("exs" "eex"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.ml")       :extensions ("ml" "mli"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "Dockerfile") :extensions ("dockerfile"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.mov")      :extensions ("webm" "mp4" "avi" "mkv" "flv" "mov" "wmv" "mpg" "mpeg" "mpv"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.tex")      :extensions ("tex"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.rkt")      :extensions ("racket" "rkt" "rktl" "rktd" "scrbl" "scribble" "plt"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "makefile")   :extensions ("makefile"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "license")    :extensions ("license"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.zip")      :extensions ("zip" "7z" "tar" "gz" "rar"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.elm")      :extensions ("elm"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.xml")      :extensions ("xml" "xsl"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.dll")      :extensions ("exe" "dll" "obj" "so" "o"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.rb")       :extensions ("rb"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.scss")     :extensions ("scss"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.lua")      :extensions ("lua"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.log")      :extensions ("log"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.lisp")     :extensions ("lisp"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.sql")      :extensions ("sql"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.org")      :extensions ("org"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.pl")       :extensions ("pl" "pm" "perl"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.r")        :extensions ("r"))
             (treemacs-create-icon :icon (all-the-icons-icon-for-file "x.re")       :extensions ("re" "rei"))))
         ;; activate the theme
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package helm
     ...
     :config
      ...
      (set-face-attribute 'helm-selection nil :background pve-highlight-color)
      (set-face-attribute 'helm-selection-line nil :background pve-highlight-color)
     ...
     (defun helm-lastpass ()
       ...
       (let ((data (helm-lastpass-source)))
         (helm :sources (helm-build-sync-source "test"
                          :candidates data
                          :action (lambda (candidate) (kill-new (lastpass-getpass (car candidate)))))
