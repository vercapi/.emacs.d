...
*** Swagger/OpenAPI YAML
   ...
   Install swagger-tools as backend for flycheck
   #+BEGIN_SRC sh
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package flycheck-swagger-tools
       :quelpa (flycheck-swagger-tools :fetcher github :repo "magoyette/flycheck-swagger-tools")
       :ensure t)
   #+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package openapi-yaml-mode
       ...
       :ensure t
       :requires flycheck-swagger-tools
