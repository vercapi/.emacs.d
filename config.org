...
** TODO WorkFlow [0/1]
   ...
   #+BEGIN_SRC emacs-lisp
     ;; TODO next line needs to be in constants file
     (defvar org-default-dir "~/flow/" "Primary Org mode directory directory")
     ...
     (defvar org-default-references-dir (concat org-default-dir "references/") "Non actionable information")
     (defvar org-default-references-dir (concat org-default-references-dir "index.org") "Index file for refrences dir")
   #+END_SRC
