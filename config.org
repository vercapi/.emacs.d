  ...
  #+BEGIN_SRC emacs-lisp
    (use-package helm
      ...
      (setq helm-split-window-in-side-p               t ; open helm buffer inside current window, not occupy whole other window
		...
		helm-follow-mode-persistent           t) ; helm-occur, buffer follows the selection in helm
      :bind (("M-x" . helm-M-x)
	     ("C-x b" . helm-mini)
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package org-mode
      ...
      ((setq org-confirm-babel-evaluate nil) ;;No need to confirm executing babel code blocks
       (require 'ob-async) ;; Enable async execution of babel code blocks
       )
      :hook 
      ((org-mode . pve-org-nav-hydra)x
       (org-mode . pve-enable-org-bullets))
      :after (hydra org-bullets))
  #+END_SRC
