  ...
  #+BEGIN_SRC emacs-lisp
   ...
   #+BEGIN_SRC emacs-lisp
     (custom-theme-set-faces 'user
                             `(org-level-1 ((t (:font "ProggyVector-17"))))
                             `(org-level-2 ((t (:font "ProggyVector-16"))))
                             `(org-level-3 ((t (:font "ProggyVector-15"))))
                             `(org-level-4 ((t (:font "ProggyVector-14"))))
                             `(org-level-5 ((t (:font "ProggyVector-13"))))
                             `(org-level-6 ((t (:font "ProggyVector-12"))))
                             `(org-level-7 ((t (:font "ProggyVector-11"))))
                             `(org-level-8 ((t (:font "ProggyVector-10")))))
   #+END_SRC
