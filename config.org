...
** Java
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package lsp-java
       ...
       (setq lsp-java--workspace-folders (list "/home/vercapi/Documents/projects/authenticationTests/OAuthProvider/"
                                               "/home/vercapi/Documents/projects/authenticationTests/OAuthEndpoint/")))
   #+END_SRC
...
*** SQL Parsing
    ...
    Simple code to see what attribute is connected to the value in the current insert/update statement.
    Works only if the attributes are defined
    #+BEGIN_SRC emacs-lisp
      (defun sql-ddl-value-attrbiute ()
        "Find the attribute name for tha value at point in an insert/updated DDL statement"
        (interactive)
  
        (save-excursion
          (setq start-point (point))
          (setq values_pos (search-backward-regexp ")[[:space:]]*values"))
          (setq start_vals (search-forward "("))
          (setq val_list (buffer-substring start_vals start-point))
          (goto-char values_pos)
          (setq param_list (buffer-substring (+ 1 (search-backward-regexp "(")) values_pos))
          (message (nth (- (length (parse-csv-string val_list ?\, ?\")) 1)
                        (parse-csv-string  param_list ?\, ?\")))))
    #+END_SRC
* File browsing
** Side bar
  ...
  #+BEGIN_SRC emacs-lisp
   ...
   #+BEGIN_SRC emacs-lisp
     (custom-theme-set-faces 'user
                             `(org-level-1 ((t (:font "DejaVu Sans Mono for Powerline-17"))))
                             `(org-level-2 ((t (:font "DejaVu Sans Mono for Powerline-16"))))
                             `(org-level-3 ((t (:font "DejaVu Sans Mono for Powerline-15"))))
                             `(org-level-4 ((t (:font "DejaVu Sans Mono for Powerline-14"))))
                             `(org-level-5 ((t (:font "DejaVu Sans Mono for Powerline-13"))))
                             `(org-level-6 ((t (:font "DejaVu Sans Mono for Powerline-12"))))
                             `(org-level-7 ((t (:font "DejaVu Sans Mono for Powerline-11"))))
                             `(org-level-8 ((t (:font "DejaVu Sans Mono for Powerline-10")))))
   #+END_SRC
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package org-gcal
        ...
        :config (setq org-gcal-client-id google-client-id
                      ...
                      org-gcal-file-alist '(("pieterv.sorano@gmail.com" . "~/Dropbox/org/calendars/priv_cal.org")
                                            ("7p9jnod969dn4b78eo14vc7fvei29g2u@import.calendar.google.com" . "~/Dropbox/org/calendars/school_cal.org")
                                            ("pieter.vercammen@contribute.be" . "~/Dropbox/org/calendars/work_cal.org")
                                            ("kbenk8l95sn8iq6v8fs7dqfhmj577kps@import.calendar.google.com" . "~/Dropbox/org/calendars/div2_cal.org")
                                            ("837fa10khalit6kttc36r1n7od5gvj0d@import.calendar.google.com" . "~/Dropbox/org/calendars/u10_cal.org"))))
    #+END_SRC
*** agenda files

    Set all org files that contain schedules, deadlines or actionable items
    
    #+BEGIN_SRC emacs-lisp
      (setq org-agenda-files
            (list "~/Dropbox/org/calendars/priv_cal.org"
                  "~/Dropbox/org/calendars/work_cal.org"
                  "~/Dropbox/org/calendars/div2_cal.org"
                  "~/Dropbox/org/calendars/u10_cal.org"
                  "~/Dropbox/org/calendars/school_cal.org"))
    #+END_SRC
