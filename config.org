...
** Fonts
   ...
   #+BEGIN_SRC emacs-lisp
     (custom-set-faces
      '(default ((t (:family "Terminus (TTF)" :foundry "PfEd" :slant normal :weight normal :height 140 :width normal))))
      '(minimap-font-face ((t (:height 40 :family "Terminus (TTF)"))))
      '(mode-line ((t (:family "Terminus (TTF)" :foundry "unknown" :slant normal :weight normal :height 140 :width normal)))))
    #+END_SRC
